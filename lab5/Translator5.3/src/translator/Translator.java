...
public class Translator {
    ...
    public OpCode getNotRelopCmp(Token relopToken) { //ritorno l'operatore relazionale opposto
    	if(relopToken==Word.lt)
    		return OpCode.if_icmpge;
    	else if(relopToken==Word.gt)
    		return OpCode.if_icmple;
    ...
    public void bexpr (int b_false){
    	...
    	switch(look.tag) {
			case Tag.RELOP:
			{
				...
				expr();
				expr();
				code.emit(getNotRelopCmp(tmp),b_false);
				break;
			}	
	 		default:
